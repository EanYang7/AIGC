...
![Edu4All startup, class on monuments, Eiffel Tower](./09_Images_App.assets/startup.pngWT.png)
...
- **CLIP**，是一种从图像和文本生成嵌入embeddings的模型，嵌入是数据的数字表示。
- **diffused attention**，是一种从嵌入生成图像的模型。 DALL-E 在图像和文本数据集上进行训练，可用于从文本描述生成图像。 例如，DALL-E 可用于生成戴帽子的猫或留着莫西干发型的狗的图像。

### Midjourney

Midjourney 的工作方式与 DALL-E 类似，它根据文本提示生成图像。 Midjourney 还可以用于使用“戴帽子的猫”或“莫西干狗”等提示来生成图像。

![图像由 Midjourney生成，机械鸽子](./09_Images_App.assets/440px-Rupert_Breheny_mechanical_dove_eca144e7-476d-4976-821d-a49c408e4f36.pngWT.png)

*图片来源维基百科，图片由 Midjourney 生成*

## DALL-E 和 Midjourney 如何运作

首先，[DALL-E](https://arxiv.org/pdf/2102.12092.pdf?WT.mc_id=academic-105485-koreyst)。 DALL-E 是一种基于带有 *自回归autoregressive transformer* 的 transformer 架构的生成式人工智能模型。
...
![Bunny on a horse holding a lollipop, version 1](./09_Images_App.assets/v1-generated-image.pngWT.png)

现在让我们运行相同的提示，我们不会两次获得相同的图像：

![Generated image of bunny on horse](./09_Images_App.assets/v2-generated-image.pngWT.png)
...
- ![Temperature 0, v1](./09_Images_App.assets/v1-temp-generated-image.pngWT.png)
- ![Temperature 0 , v2](./09_Images_App.assets/v2-temp-generated-image.pngWT.png)
