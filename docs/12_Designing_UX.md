...
![图片说明人工智能中的用户体验考虑因素](./12_Designing_UX.assets/uxinai.pngWT.png)
...
![一个应用程序登陆页面，清楚地说明人工智能应用程序中的可解释性](./12_Designing_UX.assets/explanability-in-ai.pngWT.png)

另一个例子是人工智能如何使用用户和个人数据。 例如，具有学生角色的用户可能具有基于其角色的限制。 人工智能可能无法揭示问题的答案，但可以帮助引导用户思考如何解决问题。

![AI根据角色回答问题](./12_Designing_UX.assets/solving-questions.pngWT.png)

可解释性的最后一个关键部分是解释的简化。 学生和教师可能不是人工智能专家，因此对应用程序可以做什么或不能做什么的解释应该简化且易于理解。

![AI能力的简单说明](./12_Designing_UX.assets/simplified-explanations.pngWT.png)
...
![带有修改提示和输出选项的 Bing 搜索结果](./12_Designing_UX.assets/bing1.pngWT.png)

Bing 中允许用户控制应用程序的另一个功能是能够选择加入和退出 AI 使用的数据。 对于学校应用，学生可能希望使用他们的笔记以及教师的资源作为复习材料。

![带有修改提示和输出选项的 Bing 搜索结果](./12_Designing_UX.assets/bing2.pngWT.png)
...
![提供反馈和处理错误](./12_Designing_UX.assets/feedback-loops.pngWT.png)
...
- **满意度：** 考虑如何使您的应用程序更加令人愉快。 您是否到处添加解释，是否鼓励用户探索？ 你是如何表述错误信息的？
